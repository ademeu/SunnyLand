...
public class PlayerController : MonoBehaviour
{
    ...
    void Jump()
    {
        ...
        {
            #region 12 �ilek toplad�g�nda player�n z�plama kuveeti art�yor.
    ...
    private void OnCollisionEnter2D(Collision2D collision) // player c�lege dokundugunda c�leg� al�yor �k�s�de �s tr�ger� yok
    {      
    ...
    private void OnTriggerEnter2D(Collider2D collision) // player kurbaga dokundugunda oluyor playerde �s tr�ger yok kurbagda var.
    {
